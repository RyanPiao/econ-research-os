### /cross-verify — Generate prompts for external AI model verification

**Trigger**: "cross-verify with Gemini/ChatGPT", "generate verification prompts", "get a second opinion from other models"

**Workflow**:

1. Read the manuscript/chapter and the verification report (if /verify was already run)
2. Generate targeted prompts for each external model, optimized for their strengths:
...
3. Save to: `./projects/[project]/reviews/cross-verify-prompts-[date].md`
4. Inform user: "Cross-verification prompts saved. Copy-paste into each platform. Compare their responses against your verification report."
